...
let MusicCard2 = () => {
    return (
     <div className=" h-screen w-screen bg-gradient-to-tr from-primary-purple to-primary-pink flex flex-col items-center justify-center gap-10 pb-10">
        <div className="bg-gradient-to-br from-primary-gray-dark to-primary-gray-light w-9/12 rounded-xl p-8 flex drop-shadow-xl gap-4">
            ...
            <div className="flex flex-col p-2 flex-[2_2_0%]">
                <div className="m-1">
                    ...
                    <audio src={audio} controls className="w-96 opacity-50"></audio>
                </div>
                <div className="m-1">
                    <p className="text-neutral-50 opacity-70 text-xs mx-4 my-1">Song title here</p>
                    <audio src={audio} controls className="w-96 opacity-50"></audio>
